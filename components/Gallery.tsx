...
const galleryImages = [
  {
    id: 1,
    alt: "Potongan fade premium",
    category: "Potongan",
    gradient: "from-amber-900/40 via-stone-900/60 to-stone-950/80",
    label: "PRECISION FADE",
  },
  {
    id: 2,
    alt: "Grooming jenggot klasik",
    category: "Grooming",
    gradient: "from-yellow-900/30 via-neutral-900/60 to-neutral-950/80",
    label: "TRIM JENGGOT",
  },
  {
    id: 3,
    ...
    category: "Suasana",
    gradient: "from-brand-gold/20 via-zinc-900/60 to-zinc-950/80",
    label: "RUANGAN KAMI",
  },
  {
    id: 4,
    alt: "Potongan tekstur modern",
    category: "Potongan",
    gradient: "from-orange-900/30 via-gray-900/60 to-gray-950/80",
    label: "TEXTURED CUT",
  },
  {
    id: 5,
    alt: "Cukur handuk panas",
    category: "Grooming",
    gradient: "from-amber-800/30 via-stone-900/60 to-stone-950/80",
    label: "CUKUR KLASIK",
  },
  {
    id: 6,
    alt: "Hasil styling",
    category: "Potongan",
    gradient: "from-yellow-800/30 via-neutral-900/60 to-neutral-950/80",
    label: "HASIL STYLING",
  },
  {
    id: 7,
    alt: "Produk grooming premium",
    category: "Suasana",
    gradient: "from-brand-gold/15 via-zinc-900/60 to-zinc-950/80",
    label: "PRODUK PREMIUM",
  },
  {
    id: 8,
    alt: "Detail skin fade",
    category: "Potongan",
    gradient: "from-amber-900/30 via-gray-900/60 to-gray-950/80",
    label: "SKIN FADE",
  },
];
        ...
        <div className="text-center mb-14">
          ...
          <ScrollReveal delay={0.1}>
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-5">
              <span className="gold-text-gradient italic">Galeri</span>
            </h2>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
            <p className="max-w-lg mx-auto text-white/40 font-body text-base leading-relaxed">
              Showcase presisi, gaya, dan keahlian dari barber ahli kami.
            </p>
          </ScrollReveal>
        </div>
        ...
        >
          <AnimatePresence mode="popLayout">
            {filtered.map((img, i) => (
              ...
              >
                <div
                  className={`aspect-square ${i === 0 ? "md:aspect-auto md:h-full" : ""} bg-gradient-to-br ${img.gradient} relative`}
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `radial-gradient(circle at 2px 2px, rgba(184,148,60,0.5) 1px, transparent 0)`,
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-4 md:p-5">
                    <span className="text-[10px] tracking-[0.25em] uppercase text-brand-gold font-body mb-1">
                      {img.category}
                    </span>
          ...
          >
            ...
            >
              {(() => {
                ...
                return img ? (
                  <div
                    className={`w-full h-full bg-gradient-to-br ${img.gradient} flex items-center justify-center`}
                  >
                    <div className="text-center">
                      ...
                      <div className="font-display text-xl text-white/60">
                        {img.label}
                      </div>
                      <div className="text-xs text-white/30 mt-2 font-body">
                        Ganti dengan foto barbershop asli
                      </div>
                    </div>
                  </div>
                ) : null;
