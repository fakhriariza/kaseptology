  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(184,148,60,0.3) 1px, transparent 1px), linear-gradient(90deg, rgba(184,148,60,0.3) 1px, transparent 1px)`,
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          Membangun kepercayaan diri melalui potongan presisi dan grooming
          klasik. Rasakan seni barbering di level terbaik.
        </motion.p>
        ...
        >
          ...
          <a href="#services" className="btn-outline rounded-lg">
            Lihat Layanan
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="font-display text-2xl md:text-3xl font-bold gold-text-gradient">
                {stat.num}
              </div>
              <div className="text-[10px] md:text-xs tracking-[0.15em] uppercase text-white/30 font-body mt-1">
                {stat.label}
              </div>
            </div>
          ))}
      ...
      >
        ...
        >
          <span className="text-[9px] tracking-[0.3em] uppercase text-white/20 font-body">
            Scroll
          </span>
