...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Kaseptology Barbershop — Pengalaman Grooming Premium",
    description:
      "Potongan rambut presisi, cukur klasik, dan grooming premium. Booking sekarang.",
    type: "website",
    locale: "id_ID",
  ...
  twitter: {
    ...
    description:
      "Pengalaman grooming premium. Potongan presisi & cukur klasik.",
  },
